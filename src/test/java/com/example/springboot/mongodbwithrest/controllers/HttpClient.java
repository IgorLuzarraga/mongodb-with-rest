...
public class HttpClient {
    ...
    public List<String> getBooksListId() {
    ...
    private String getBaseUrlWithId(String id){
    ...
    private Option<HttpGet> getHttpGetOne(String id){
        return getHttpGet(getUri(getBaseUrlWithId(id)));
    }

    private Option<HttpDelete> getHttpDelete(String id){
    ...
    private Optional<HttpPut> getHttpUpdate(String id, Book book)  {
