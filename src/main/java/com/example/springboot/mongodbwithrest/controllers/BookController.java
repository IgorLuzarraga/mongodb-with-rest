...
import com.example.springboot.mongodbwithrest.exceptions.BookNotFoundException;
import com.example.springboot.mongodbwithrest.services.BookResourceAssemblerService;
...
public class BookController {
    ...
    // get book id
    @GetMapping("/books/{id}")
    public Resource<Book> one(@PathVariable String id) {
    ...
    // update book id
    @PutMapping("/books/{id}")
    public ResponseEntity<?> replaceBook(@RequestBody Book newBook, @PathVariable String id) throws URISyntaxException {
